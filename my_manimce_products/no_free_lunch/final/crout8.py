...
class MatrixExample(MovingCameraScene):
    def construct(self):
        ...
        self.play(
            self.camera.frame.animate.set( width = 44.4444 ).shift(UP*8.88888888),
        )
        self.play(
            self.camera.frame.animate.set( width = 16.6666 ).shift(DOWN*8.88888888),
        )
        ...
        tex_however = Tex(r"However, this method is too \textbf{indirective}, \\ cuz we need to calculate matrices $L_1L_2...L_{n-1}$ for n-1 times, then find their inverse")
        ...
        tex_when1 = Tex("When i $\geq$ j, that is, ").next_to(matrix_u, RIGHT)
        ...
        self.play(self.camera.frame.animate.shift(LEFT * 16.88888888),)
        ...
        time_long = 0.08080808
        time_short = 0.02020202
        self.play(Create( SurroundingRectangle(ent_crout_seq[0]) ), run_time = time_long)
        self.play(Create( SurroundingRectangle(ent_crout_seq[1]) ), run_time = time_short)
        self.play(Create( SurroundingRectangle(ent_crout_seq[2]) ), run_time = time_short)
        self.play(Create( SurroundingRectangle(ent_crout_seq[3]) ), run_time = time_short)
        self.play(Create( SurroundingRectangle(ent_crout_seq[4]) ), run_time = time_short)
        self.wait(0.02020202)
        print('next line')
        
        self.play(Create( SurroundingRectangle(ent_crout_seq[5]) ), run_time = time_long)
        self.play(Create( SurroundingRectangle(ent_crout_seq[6]) ), run_time = time_long)
        self.play(Create( SurroundingRectangle(ent_crout_seq[7]) ), run_time = time_short)
        self.play(Create( SurroundingRectangle(ent_crout_seq[8]) ), run_time = time_short)
        self.play(Create( SurroundingRectangle(ent_crout_seq[9]) ), run_time = time_short)
        self.wait(0.02020202)
        print('next line')
        
        self.play(Create( SurroundingRectangle(ent_crout_seq[10]) ), run_time = time_long)
        self.play(Create( SurroundingRectangle(ent_crout_seq[11]) ), run_time = time_long)
        self.play(Create( SurroundingRectangle(ent_crout_seq[12]) ), run_time = time_long)
        self.play(Create( SurroundingRectangle(ent_crout_seq[13]) ), run_time = time_short)
        self.play(Create( SurroundingRectangle(ent_crout_seq[14]) ), run_time = time_short)
        self.wait(0.02020202)
        print('next line')
    
        self.play(Create( SurroundingRectangle(ent_crout_seq[15]) ), run_time = time_long)
        self.play(Create( SurroundingRectangle(ent_crout_seq[16]) ), run_time = time_long)
        self.play(Create( SurroundingRectangle(ent_crout_seq[17]) ), run_time = time_long)
        self.play(Create( SurroundingRectangle(ent_crout_seq[18]) ), run_time = time_long)
        self.play(Create( SurroundingRectangle(ent_crout_seq[19]) ), run_time = time_long)
        self.wait(0.02020202)
        print('next line')
