...
class MatrixExample(Scene):
    def construct(self):
        ...
        matrix_label_b.next_to(matrix_rect_b, DOWN)
        ...
        group = VGroup(matrix_rect_a, matrix_rect_b, matrix_label_b, matrix_rect_c, matrix_label_c)
        self.play(FadeOut(group))

        equation_text = Text("AX = P", font_size=36)
        equation_text.to_edge(DOWN)
