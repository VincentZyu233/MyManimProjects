...
class Calendar(MovingCameraScene):
    def construct(self):   
        ...
        self.play(
            ...
            Create(daynums, run_time = 2.2222+0.8888),
            self.camera.frame.animate.set(width = self.camera.frame.get_width()+2.2222+0.8888).shift(DOWN*2.2222+UP*0.4444+RIGHT*2.2222+RIGHT*0.8888+DOWN*2.2222),
            title.animate.shift(RIGHT*4.4444+DOWN*2.2222+RIGHT*2.2222+UP*0.4444+RIGHT*0.8888+RIGHT*0.2222).scale(0.4444+0.2222)
        )
