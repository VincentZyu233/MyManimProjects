...
class MatrixExample(MovingCameraScene):
    def construct(self):
        ...
        def draw3( idx, time1, time2 ): 
            ...
            line1 = point_from_to(entries_p[idx].get_center(), entries_c[x].get_center()).set_color( RED_C )
            line2 = point_from_to(entries_p[idx].get_center(), entries_c[y].get_center()).set_color( BLUE )
            line3 = point_from_to(entries_p[idx].get_center(), entries_c[z].get_center()).set_color( RED_C )
            
            line1_label = Tex(r"0.5").move_to(line1)
            line2_label = Tex(r"2").move_to(line2)
            line3_label = Tex(r"0.5").move_to(line3)
        ...
        dengyu_p = MathTex(r"= \quad P").next_to(vlielielie, RIGHT)
        ...
        group_youxuanji = VGroup(and_u_youxuanji,bv_xuanji,vlielielie,dengyu_p,andandand,bujiac_xuanji,ulielielie,jiac_dengyu_0).next_to(group_and_ie, DOWN)
